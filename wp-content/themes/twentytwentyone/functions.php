...
class Product_Info_Widget extends WP_Widget
{
	...
	public function __construct()
	{
		parent::__construct(
			'product_info_widget',
			'Product Info Widget',
			array('description' => 'Muestra información relacionada con los productos en la barra lateral de la tienda.')
		);
	}

	// Función para mostrar el formulario de configuración del widget en el panel de administración
	public function form($instance)
	{
		$title = isset($instance['title']) ? esc_attr($instance['title']) : '';

		// Mostrar el formulario en el panel de administración
	?>
		<p>
...
<?php
	...
	// Función para actualizar los datos del widget en la base de datos
	...
	public function widget($args, $instance)
	{
		...
		if ($product_info) {
			...
			echo '<p>No se encontró información de productos.</p>';
		}
	...
	private function get_product_info()
	{
		...
		$args = array(
			'status' => 'publish', // Productos publicados
			'limit' => 3, // limitar 
		);
		...
		if ($products) {
			...
			$formatted_products = array_map(function ($product) {
				...
				return  'Nombre: ' . $product_name . ', Precio: ' . $product_price;
			}, $products);
		} else {
...
// Registrar el widget
function register_product_info_widget()
{
	register_widget('Product_Info_Widget');
}
add_action('widgets_init', 'register_product_info_widget');
